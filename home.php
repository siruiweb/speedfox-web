...
$productdata= mysqli_query($conn,"select * from fa_ruyi_oem where name = '$product'");
    ...
    <div class="app_box window_radius">
        ...
        <div class="nav">
            ...
            <div class="user_top_info">
                <img src="/static/img/avater.png" class="avater">
        ...
        <div class="start_game app_page">
            <div class="game_img_bg">
                <div class="MASK"></div>
                <img src="/static/img/wallpapers.jpg" class="game_bg">
            ...
            <div class="box">
                ...
                <div class="layui-panel info">
                  <div class="server_info">
                      <p>xxx服务器</p>
                      <img src="/static/img/1udp-err.png" class="udp_ico">
                  </div>
                </div>
